...
export default class CustomMap extends Component {
    ...
    render() {
        return(
            <div className="map" style={{width: '100vw', height: '100%'}}>
                <WrappedMap 
                    googleMapURL={`https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=geometry,drawing,places&key=AIzaSyB2YeMKniOp8PvU2qPj99m7LTedKOEGYUM`} 
